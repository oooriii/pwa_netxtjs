...
### Pas 14 — Hotfix lint parsing layout.tsx
- [x] Diagnosticar error de parsing ESLint a `src/app/layout.tsx`.
- [x] Evitar `React.ReactNode` i usar import de tipus `ReactNode`.
- [x] Test/check: validacions disponibles en entorn actual.
- [x] Commit del pas.
